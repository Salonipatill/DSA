...
cout<<"input:"<<sentence1<<", Discount:"<<discount1
<<"%"<<endl;
cout<<"output:"<<sol.discountPrices(sentence1, discount1)<<endl<<endl;

string sentence2 = "This book costs $3o";
int discount2 = 10;
cout<<"Input"<<sentence2<<", Discount:"<<discount2
<<"%"<<endl;
cout<<"Output:"<<sol.discountPrices(sentence2, discount2)<<endl<<endl;
